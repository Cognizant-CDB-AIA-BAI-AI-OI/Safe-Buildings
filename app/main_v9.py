    ...
    if (PCameraID):
        ...
        for j in data['areas']['areas']:
            ...
            for i in range(len(pedestrian_boxes)):
                x = int(int((pedestrian_boxes[i][0] + pedestrian_boxes[i][2] ) / 2)*scale_w)
        ...
        # transformation matrix using extreme points
        #M = findTransformationMatrix(data)
